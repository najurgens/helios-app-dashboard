...
export class ObjectSettingsComponent {
    ...
    shiftSelectedObjectsRight() {
      ...
      const assignObjects = (key) => this.assignedObjects[key] = [0,0,0,0,1,1];
    ...
    shiftSelectedObjectsLeft() {
      ...
      const unassignObjects = (key) => this.availableObjects[key] = [0,0,0,0,1,1];
