...
export class ObjectSettingsComponent implements OnInit {
  ...
  shiftSelectedObjectsRight() {
    const assignObjects = (key) => {
      ...
      const sortedObjects = {};
      Object.keys(this.assignedObjects)
        .sort()
    ...
    const removeFromAvailableObjects = (key) =>
      delete this.availableObjects[key];
  ...
  shiftSelectedObjectsLeft() {
    const unassignObjects = (key) => {
      ...
      const sortedObjects = {};
      Object.keys(this.availableObjects)
        .sort()
        .forEach(function (key) {
  ...
  parseArrayIntoPermissions(permissions: Array<Number>) {
    ...
    permissions[0] == 1
      ? keyPermissions.push("Create")
      : nonKeyPermissions.push("Create");
    permissions[1] == 1
      ? keyPermissions.push("Read")
      : nonKeyPermissions.push("Read");
    permissions[2] == 1
      ? keyPermissions.push("Edit")
      : nonKeyPermissions.push("Edit");
    permissions[3] == 1
      ? keyPermissions.push("Delete")
      : nonKeyPermissions.push("Delete");
    permissions[4] == 1
      ? keyPermissions.push("View All")
      : nonKeyPermissions.push("View All");
    permissions[5] == 1
      ? keyPermissions.push("Modify All")
      : nonKeyPermissions.push("Modify All");
  ...
  shiftPermissionsRight() {
    ...
    const removeFromAvailablePermissions = (key) =>
      this.availablePermissionsList.splice(
        this.availablePermissionsList.indexOf(key),
        1
      );
  ...
  shiftPermissionsLeft() {
    const unassignPermissions = (key) =>
      this.availablePermissionsList.push(key);
    const removeFromAssignedPermissions = (key) =>
      this.keyPermissionsList.splice(this.keyPermissionsList.indexOf(key), 1);
    const arp = this.assignOrRemovePermissionFromMap;
  ...
  assignOrRemovePermissionFromMap(
    keyObject: string,
    permission: string,
    assign: boolean,
    assignedObjects: Object
  ) {
    if (assign) {
      switch (permission) {
        case "Create":
          assignedObjects[keyObject][0] = "C";
          break;
        case "Read":
          assignedObjects[keyObject][1] = "R";
          break;
        case "Edit":
          assignedObjects[keyObject][2] = "E";
          break;
        case "Delete":
          assignedObjects[keyObject][3] = "D";
          break;
        case "View All":
          assignedObjects[keyObject][4] = "V";
          break;
        case "Modify All":
          assignedObjects[keyObject][5] = "M";
          break;
      }
    } else {
      switch (permission) {
        case "Create":
          assignedObjects[keyObject][0] = "";
          break;
        case "Read":
          assignedObjects[keyObject][1] = "";
          break;
        case "Edit":
          assignedObjects[keyObject][2] = "";
          break;
        case "Delete":
          assignedObjects[keyObject][3] = "";
          break;
        case "View All":
          assignedObjects[keyObject][4] = "";
          break;
        case "Modify All":
          assignedObjects[keyObject][5] = "";
          break;
      }
    }
  }
