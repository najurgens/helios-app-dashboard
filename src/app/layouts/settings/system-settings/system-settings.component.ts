  ...
  ngOnInit(): void {
    this.accountService.keyPermissions.subscribe((permissions) => {
      if (JSON.stringify(permissions) === "{}") this.dataService.getAllData();
        ...
        this.userPermissions["PermissionsManageInternalUsers"] =
          permissions["PermissionsManageInternalUsers"];
        delete this.systemPermissions["PermissionsManageInternalUsers"];
        this.userPermissions["PermissionsManageIpAddresses"] =
          permissions["PermissionsManageIpAddresses"];
        delete this.systemPermissions["PermissionsManageIpAddresses"];
        this.userPermissions["PermissionsManageLoginAccessPolicies"] =
          permissions["PermissionsManageLoginAccessPolicies"];
        delete this.systemPermissions["PermissionsManageLoginAccessPolicies"];
        this.userPermissions["PermissionsManagePasswordPolicies"] =
          permissions["PermissionsManagePasswordPolicies"];
        delete this.systemPermissions["PermissionsManagePasswordPolicies"];
        this.userPermissions["PermissionsManageRoles"] =
          permissions["PermissionsManageRoles"];
        delete this.systemPermissions["PermissionsManageRoles"];
        this.userPermissions["PermissionsManageSharing"] =
          permissions["PermissionsManageSharing"];
        delete this.systemPermissions["PermissionsManageSharing"];
        this.userPermissions["PermissionsManageUsers"] =
          permissions["PermissionsManageUsers"];
        ...
        this.systemPermissionsKeysB = this.systemPermissionsKeys.slice(
          len2 / 2,
          len2
        );
